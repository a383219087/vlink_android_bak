...
public class HeYueLikeDataService {
    ...
    private HeYueLikeDataService() {
        mMMKVDb = new MMKVDb();
    }

    private static HeYueLikeDataService mLikeDataService;

    public static HeYueLikeDataService getInstance() {
        if (null == mLikeDataService) {
            mLikeDataService = new HeYueLikeDataService();
        }
    ...
    public void saveCollecData(ArrayList<JSONObject> symbols) {
        for (int i = 0; i < symbols.size(); i++) {
            ...
            HeYueLikeDataService.getInstance().saveCollecData(symbolObj,symbols.get(i));
        }
    }
