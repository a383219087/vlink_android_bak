...
//        return subZeroAndDot(plainString);
    ...
    public static String canPositionStr(String position, String parValue, int scale, String unit) {
        ...
        if (LogicContractSetting.getContractUint(ContractSDKAgent.INSTANCE.getContext()) == 0) {
            ...
            //张=数量/面值
            return divStr(position, parValue, 0) + " " + "张";
    ...
    public static String canPositionMarketStr(boolean isForward, String marginRate, String parValue, String openValue, String price, int scale, String unit) {
        ...
        if (LogicContractSetting.getContractUint(ContractSDKAgent.INSTANCE.getContext()) == 1) {
            return buff.toPlainString() + " " + unit;
        } else {
            return buff.divide(parValueBig, scale, BigDecimal.ROUND_HALF_DOWN).toPlainString() + " " + "张";
        }
    }
     ...
     * @return
     */
    public static String getOrderNum(String inputNum, String multiplier, int orderType) {
        if (orderType == 2) {//市价单
            return inputNum;
        } else if (orderType == 3) {//条件单
            //0限价 1市价
