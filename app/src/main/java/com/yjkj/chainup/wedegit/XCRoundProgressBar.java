...
public class XCRoundProgressBar extends View {
    ...
    public XCRoundProgressBar(Context context, AttributeSet attrs,
        ...
        textColor = typedArray.getColor(R.styleable.XCRoundProgressBar_textColor2, Color.RED);
        textSize = typedArray.getDimension(R.styleable.XCRoundProgressBar_textSize2, 15);
