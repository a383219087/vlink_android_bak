...
private Context context;
    ...
    protected String[] convertData(WheelDateView wheelDateView, Integer[] data) {
        if (wheelDateView == yearView) {
            return datePicker.getDisplayValue(data, LanguageUtil.getString(context,"noun_date_year"));
        } else if (wheelDateView == monthView) {
            return datePicker.getDisplayValue(data, LanguageUtil.getString(context,"noun_date_month"));
        } else if (wheelDateView == dayView) {
            return datePicker.getDisplayValue(data, LanguageUtil.getString(context,"noun_date_day"));
