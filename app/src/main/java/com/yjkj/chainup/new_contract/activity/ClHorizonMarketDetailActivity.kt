 ...
 *
 */
class ClHorizonMarketDetailActivity : NBaseActivity(), WsContractAgentManager.WsResultCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mPricePrecision = LogicContractSetting.getContractSymbolPricePrecisionById(this, intent.getIntExtra("contractId", -1))

        mMultiplierCoin = LogicContractSetting.getContractMultiplierCoinPrecisionById(this, intent.getIntExtra("contractId", -1))

        mMultiplierPrecision = LogicContractSetting.getContractMultiplierPrecisionById(this, intent.getIntExtra("contractId", -1))

        coUnit = LogicContractSetting.getContractUint(this)

        mMultiplier = LogicContractSetting.getContractMultiplierById(this, intent.getIntExtra("contractId", -1))

        tv24hVolUnit = if (LogicContractSetting.getContractUint(this) == 0) " " + "张" else " " + mMultiplierCoin
...
//        tv_coin_map?.text = coinMap
        tv_coin_map?.text = LogicContractSetting.getContractShowNameById(mActivity, intent.getIntExtra("contractId", -1));
        isFrist = true
        klineData.clear()
