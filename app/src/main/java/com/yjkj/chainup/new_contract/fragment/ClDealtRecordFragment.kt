 ...
 * DONE
 */
class ClDealtRecordFragment : Fragment() {
    val TAG = ClDealtRecordFragment::class.java.simpleName
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        ClDepthFragment.liveData.observe(this, Observer {
