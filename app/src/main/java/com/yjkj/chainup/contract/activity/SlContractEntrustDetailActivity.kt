...
//        list.addAll(Gson().fromJson<List<ContractOrder>>(contractJson, object : TypeToken<List<ContractOrder?>?>() {}.type))
    ...
    override fun initView() {
        ...
        contractOrder?.let {
            ...
            tv_deal_price.text = getLineText("contract_text_dealAverage")+" (${contract.showQuoteName()})"
            //手续费
            tv_fee.text =  getLineText("sl_str_fee")+" (${contract.showMarginName()})"
    ...
    fun updateContractDetail(){
        contractOrder?.let {
            ...
            list.forEach { item ->
                ...
                findChildView(R.id.tv_item_deal_price,itemView)?.text  = getLineText("sl_str_deal_price")+" (${contract.showQuoteName()})"
                //成交数量
                ...
                findChildView(R.id.tv_item_deal_avg_price,itemView)?.text = getLineText("sl_str_deal_money")+" (${contract.showMarginName()})"
