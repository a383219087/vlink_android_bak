...
class SlDepthFragment : NBaseFragment(){
    ...
    override fun initView() {
        ...
        contract?.let {
            ...
            tv_buy_volume_title.text =getLineText("charge_text_volume") + "(" + (if (unit == 0)getLineText("sl_str_contracts_unit") else it.showBaseName()) + ")"
            tv_sell_volume_title.text = getLineText("charge_text_volume") + "(" + (if (unit == 0) getLineText("sl_str_contracts_unit") else it.showBaseName()) + ")"
            tv_price_title.text = getLineText("contract_text_price") + "(" + contract.showQuoteName()+ ")"
        }
