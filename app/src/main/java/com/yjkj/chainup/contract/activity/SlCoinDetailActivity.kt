...
class SlCoinDetailActivity : NBaseActivity() {
    ...
    override fun onInit(savedInstanceState: Bundle?) {
        ...
        coinCode = intent.getStringExtra("coinCode") ?: "USDT"
        initView()
        loadData()
    }
    ...
    override fun initView() {
        ...
        collapsing_toolbar?.let {
            ...
            it.title = NCoinManager.getShowMarket(coinCode)
        }
        ...
        tv_coin_title.text = NCoinManager.getShowMarket(coinCode) + getLineText("sl_str_position")
    ...
    private fun updateAssetHeaderUi(isLoad: Boolean = false) {
        ...
        account?.let {
            ...
            val contractPositions: List<ContractPosition>? = ContractUserDataAgent.getCoinPositions(it.coin_code, isLoad)
