    ...
    private fun initAttrs(attrs: AttributeSet?) {
        ...
        if (array != null) {
            try {
                ...
                setGridLineColor(array.getColor(R.styleable.KLineChartView_kc_grid_line_color, ColorUtil.getColor(context, R.color.kline_grid_line_new)))
                ...
                setMarkerTitleColor(array.getColor(R.styleable.KLineChartView_kc_text_color, ColorUtil.getColor(context, normal_text_color)))
