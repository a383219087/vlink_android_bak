    ...
    override fun convert(helper: BaseViewHolder, item: JSONObject) {
        ...
        when (assetState) {
            ParamConstant.FABI_INDEX -> {
                ...
                helper?.setText(R.id.tv_equivalent,  LanguageUtil.getString(context, "assets_text_equivalence") + "(${RateManager.getCurrencySign()})")
            ...
            ParamConstant.LEVER_INDEX -> {
                ...
                helper?.setText(R.id.tv_equivalent_all,  LanguageUtil.getString(context, "assets_text_equivalence") + " " + result + RateManager.getCurrencyLang())
            }
