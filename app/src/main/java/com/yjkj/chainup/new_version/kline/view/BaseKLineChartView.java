...
public abstract class BaseKLineChartView extends ScrollAndScaleView {
    ...
    private void init() {
        ...
        priceLineRightPaint.setColor(ColorUtil.INSTANCE.getColorByMode(R.color.right_price_text_color_day,true));
...
//            showPriceLabelInLine = false;
    ...
    private void renderRightPriceLabel(Canvas canvas, float y, String priceString, float textWidth, float textLeft) {
        ...
        priceLineRightTextPaint.setColor(ColorUtil.INSTANCE.getColorByMode(R.color.right_price_text_color_day,true));
        priceLineRightTextPaint.setTextSize(SizeUtils.dp2px(10f));
