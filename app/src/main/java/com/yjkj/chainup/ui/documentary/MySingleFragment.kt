...
class MySingleFragment : BaseMVFragment<SingleViewModel?, FragmentSingleBinding?>(){
    ...
    override fun initView() {
        ...
        mFragments?.add(NowDocumentaryFragment.newInstance(2,arguments?.getString(ParamConstant.MARKET_NAME)!!))
        mFragments?.add(HisDocumentaryFragment.newInstance(0,arguments?.getString(ParamConstant.MARKET_NAME)!!))
