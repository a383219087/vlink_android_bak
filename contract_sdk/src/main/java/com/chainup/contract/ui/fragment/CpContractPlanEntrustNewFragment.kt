...
import kotlinx.android.synthetic.main.cp_fragment_cl_contract_hold.img_not_switch
import kotlinx.android.synthetic.main.cp_fragment_cl_contract_hold.img_switch
...
class CpContractPlanEntrustNewFragment : CpNBaseFragment() {
    ...
    private fun initOnClick() {
        ...
        img_switch.setOnClickListener {
            CpPreferenceManager.putBoolean(activity!!, CpPreferenceManager.isShowAllContractPlan, false)
            showSwitch()
        }
        //未选中切换成选中
        img_not_switch.setOnClickListener {
            CpPreferenceManager.putBoolean(activity!!, CpPreferenceManager.isShowAllContractPlan, true)
            showSwitch()
        }
