...
import com.yjkj.chainup.new_contract.adapter.CpContractDropAdapter2
...
class CpCoinSearchItemFragment2 : CpNBaseFragment(), CpWsContractAgentManager.WsResultCallback {
    ///  (反向：0，1：正向 , 2 : 混合 , 3 : 模拟)
    private var index = 0
    private var contractDropAdapter: CpContractDropAdapter2? = null
    ...
    companion object {
        ...
        fun newInstance2(index: Int, contractListJson: String): CpCoinSearchItemFragment2 {
            val fg = CpCoinSearchItemFragment2()
            val bundle = Bundle()
